...
<template>
    <div class="group relative rounded-xl overflow-hidden bg-white dark:bg-gray-800 shadow transition hover:-translate-y-1 hover:shadow-lg cursor-pointer"
        @click="openInNewTab">

        <button @click.stop="askDestroy"
            class="absolute top-2 right-2 z-10 w-7 h-7 rounded bg-gray-800/80 flex items-center justify-center opacity-0 group-hover:opacity-100 transition">
